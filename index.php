...
<body id="vis" style="margin: 0px;">
	...
	<div id="intro" class="centered">
		...
		<div>
			...
			<span id="line1" class="emphasized"><a>Social Dreaming</a></span><br/><span id="line2">A repository of dreams, connected each others.</span><div style="margin-top:50px"><img src='images/mona.png'/></div>
			<?php } else { ?>
			<a>
