	...
	<div id="wrapper">
		...
		<div id="content" class="narrow" style="display:inline-block;position:relative">
			...
			<div id='question-about' class='section'>
				...
				<p>Curators: <a href='http://' target='_blank'>Yassine</a><br/><a class='x-small' style='margin-top:10px;' href='javascript:show("faq")'>Want to know more?</a></p>
